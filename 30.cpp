...
int main() {
    ...
    // Compute CBC-MAC for the original one-block message
    cbc_mac(mac, key, message, BLOCK_SIZE);
    printf("CBC-MAC of the one-block message: ");
    print_block(mac);

    // Create the extended message: X || (XT)
